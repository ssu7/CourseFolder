...
You will need a computer with \LaTeX\ and R installed. 
If you have a laptop, you should install the most recent version of R  and
\LaTeX\ on it. 
This will be explained. If you do not have your own laptop, R and \LaTeX\ 
may be available in the Krieger labs and on computers in the AMS Computing Lab
(on which AMS masters' students have priority).
...
\Holiday{10/19/2012}{\emph{Due: Midterm Presentation}}
\Holiday{11/2/2012}{\emph{Due: Progress Report}}
\Holiday{11/21/2012}{\emph{Thanksgiving Break Begins}}
\Holiday{11/16/2012}{\emph{Due: Final Presentation}}
\Holiday{12/7/2012}{\emph{Due: Final Report}}
