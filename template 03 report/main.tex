...
\begin{center}
\textbf{{\large Mathematical Modeling and Consulting Final Report}}\\
...
% Home Department
\vspace \shiftdowna
\underline {Your Home Department}\\ 
\vspace{5pt}
\textbf{{\large Applied Mathematics and Statistics}} \\
...
\vspace{5pt}
John Doe (Project Manager), \texttt{john.doe@jhu.edu} \\
\vspace{10pt}
Jane Doe (Report Coordinator), \texttt{jane.doe@jhu.edu}\\

% INSTRUCTOR
\vspace \shiftdownb
\underline {Academic Mentor} \\
\vspace{5pt}
\text{Dr.~N.~.H.~Lee}, \texttt{nhlee@jhu.edu}
